...
from transformers import BertConfig, PretrainedConfig,ElectraConfig
import json
    ...
    def __init__(self, **kwargs):
        ...
        if self.class_type == 'multi':
            ...
            self.test_normal_path = './{}/{}/multi_mid_dataset/test/normal_test.txt'.format(self.dataset_type,
                                                                                      self.dataset_name)
            self.dep_type_path = './{}/{}/multi_mid_dataset/dep_type.json'.format(self.dataset_type, self.dataset_name)
            ...
            self.output_dir = './outputs/save_models/{}_schema_{}/single/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
            self.dep_type_path = './{}/{}/single_mid_dataset/dep_type.json'.format(self.dataset_type, self.dataset_name)
        elif self.class_type == 'abs_single':

            self.train_normal_path = './{}/{}/abs_single_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/abs_single_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/abs_single_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/abs_single/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
        elif self.class_type == 'all_abs_single':
            self.train_normal_path = './{}/{}/all_abs_single_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/all_abs_single_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/all_abs_single_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/all_abs_single/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
        elif self.class_type == 'abs_mid':
            self.train_normal_path = './{}/{}/abs_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/abs_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/abs_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/abs_mid/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
        elif self.class_type == 'all_abs_mid':
            self.train_normal_path = './{}/{}/all_abs_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/all_abs_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/all_abs_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/all_abs_mid/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
        elif self.class_type == 'neg_mid':
            self.train_normal_path = './{}/{}/neg_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/neg_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.test_normal_path = './{}/{}/neg_mid_dataset/test/normal_test.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/neg_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/neg_mid/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
            self.dep_type_path = './{}/{}/neg_mid_dataset/dep_type.json'.format(self.dataset_type, self.dataset_name)
        elif self.class_type == 'all_neg_mid':
            self.train_normal_path = './{}/{}/all_neg_mid_dataset/train/normal_train.txt'.format(self.dataset_type,
                                                                                               self.dataset_name)
            self.dev_normal_path = './{}/{}/all_neg_mid_dataset/dev/normal_dev.txt'.format(self.dataset_type,
                                                                                         self.dataset_name)
            self.relation_labels = './{}/{}/all_neg_mid_dataset/labels.txt'.format(self.dataset_type, self.dataset_name)
            self.output_dir = './outputs/save_models/{}_schema_{}/all_neg_mid/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
        else:
            ...
            self.output_dir = './outputs/save_models/{}_schema_{}/{}/'.format(self.model_name, kwargs['scheme'],
                                                                              self.dataset_name)
            self.dep_type_path = './{}/{}/mid_dataset/dep_type.json'.format(self.dataset_type, self.dataset_name)
        if 'spacy' in self.model_name:
            with open(self.dep_type_path,'r') as f:
                self.dep_dict = json.load(f)
                self.key_len = len(self.dep_dict)
...
class MyBertConfig(BaseConfig,BertConfig,FLASHConfig):
    def __init__(self, **kwargs):
        ...
        self.sent_max_len = kwargs['sent_max_len']
        self.neg_len = kwargs ['neg_len']
        ...
        self.l1_lambda = kwargs['l1_lambda']

        self.num_chosn_neighbors = kwargs['num_chosn_neighbors']
        self.num_GPNN_output_node = kwargs['num_GPNN_output_node']
...
class BioElectraConfig(BaseConfig,ElectraConfig):
    def __init__(self, **kwargs):
        super(BioElectraConfig, self).__init__(**kwargs)
        super(BaseConfig,self).__init__(**kwargs)
