...
def set_cv_config(config,idx):
    ...
    if config.data_format == 'single':
        ...
        config.train_normal_path = './{}/{}/neg_cv5/cv_{}/train/normal_train.txt'.format(config.dataset_type, config.dataset_name,idx)
        config.dev_normal_path = './{}/{}/neg_cv5/cv_{}/dev/normal_dev.txt'.format(config.dataset_type,
                                                                                    config.dataset_name, idx)
        config.test_normal_path = './{}/{}/neg_cv5/cv_{}/test/normal_test.txt'.format(config.dataset_type,
                                                                                    config.dataset_name, idx)
